...
import { create_doctoruser } from '../actions/auth'
import { Navigate } from 'react-router-dom'

const DoctorSignin = ({create_doctoruser, isAuthenticated, isDoctor, isLoading}) => {
    ...
    const handleChange=(e)=>setDoctor({
        ...doctor,
        [e.target.name]:e.target.value })
        
    const {username, email, password, password2}=doctor
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await create_doctoruser(newDoctor);
        } catch (error) {
            ...
            <div className="col-md-6 right-box-srt">
                <div className="row align-items-center">
                    ...
                    <div className="header-text b-4 text-info">
                        <h2 className="main-text-srt">DOCTOR SIGN UP</h2>
                    </div>
...
DoctorSignin.propTypes = {
    create_doctoruser: PropTypes.func.isRequired,
    isAuthenticated: PropTypes.bool,
    isDoctor: PropTypes.bool,
    isLoading: PropTypes.bool
  };

export default connect(mapStateToProps, {create_doctoruser})(DoctorSignin)
